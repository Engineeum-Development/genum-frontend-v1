	...
	return (
		<>
			<p className="text-[#202124] text-[17px]  max-w-[384px]">
				Enter the email address linked with your account and a link to
...
function Step2({ handleClick }: { handleClick: () => void }) {
	return (
		<>
			...
			/>
			<p className="mt-[14px] text-[#060909] font-semibold">
				RESET PASSWORD
			</p>
	...
	return (
		<>
			...
			<p className="mt-10 text-center max-w-[384px] mb-5">
				Your password reset was successful. Please login with your new
				password
			</p>
		</>
	);
