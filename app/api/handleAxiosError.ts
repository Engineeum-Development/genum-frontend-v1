...
/**
 * Interface for Axios-like error structure
 */
			...
			switch (status) {
				case 400:
					handledError = {
						...
						message:
							responseMessage ||
							errorMessages[ErrorCode.BAD_REQUEST],
				...
				case 408:
					handledError = {
						...
						message:
							responseMessage || errorMessages[ErrorCode.TIMEOUT],
					};
					break;
				case 409:
					handledError = {
						...
						message:
							responseMessage ||
							errorMessages[ErrorCode.CONFLICT],
						data: responseData?.data,
					};
					break;
				case 500:
					handledError = {
						...
						message:
							responseMessage ||
							errorMessages[ErrorCode.SERVER_ERROR],
					};
					break;
				default:
					handledError = {
